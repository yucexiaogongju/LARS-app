...
工具核心用途：预测直肠癌患者术后6个月内发生LARS的风险，为临床医护工作者提供术后管理决策支持，也帮助患者及家属提前了解康复风险，辅助制定个性化自我护理方案。
""")

# 参考文献
st.markdown("### 团队相关研究成果")
st.markdown("""
1. 汪晓东, 黄明君, 李立, 等. 结直肠癌术后LARS预测模型的构建方法及预测系统[P]. 中国专利: ZL 2023 1 0088636.5, 2023-05-02.
2. Ye L, Huang MJ, Huang YW, et al. Risk factors of postoperative low anterior resection syndrome for colorectal cancer: A meta-analysis[J]. Asian Journal of Surgery, 2022, 45: 39-50.
3. 张纯, 林雨昕, 李琳, 等. 直肠癌术后低位前切除综合征的风险预测模型构建：基于随机森林算法[J]. 中国普外基础与临床杂志, 2025, 32(7): 845-852.
""")
st.divider()
